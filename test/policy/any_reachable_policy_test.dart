...
void main() {
  ...
  feature('AnyReachablePolicy', () {
    scenario('returns Reachable when at least one probe succeeds', () async {
    ...
    scenario('returns Unreachable carrying every failure when none succeed', () async {
    ...
    scenario('returns on first success without waiting for slow pending probes', () async {
    ...
    scenario('classifies the winning probe as slow when above threshold', () async {
      final probe = StubProbe(
        (target) async =>
    ...
    scenario("completes pending probes' cancelSignal after first-success resolution", () async {
    ...
    scenario("completes every probe's cancelSignal after all-fail resolution", () async {
      final probe = StubProbe(
        (target) async =>
